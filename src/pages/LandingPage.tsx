...
import { ArrowRight, Search, FileSearch, Wrench } from 'lucide-react';
      ...
      <main id="main-content">
        ...
        >
          ...
          <div className="relative z-10 text-center px-6 max-w-4xl mx-auto hero-content">
            <h2
              id="hero-heading"
              className="text-5xl md:text-7xl font-bold mb-6 text-[#E0E0E0] font-['Rajdhani']"
            >
          ...
          >
            <div className="w-6 h-10 border-2 border-[#00F0FF]/50 rounded-full flex justify-center pt-2">
              <div className="w-1.5 h-3 bg-[#00F0FF]/50 rounded-full" />
            </div>
          </div>
        </section>
        
        {/* How It Works Section */}
        <section className="py-20 px-6 bg-[#0A0A0F]" aria-labelledby="how-it-works-heading">
